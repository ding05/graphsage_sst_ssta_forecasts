...
optimizer.add_param_group({'params': criterion.noise_sigma, 'lr': 0.01, 'name': 'noise_sigma'})
...
for epoch in range(num_epochs):
    ...
    print('Validation MSE by epoch:', [float('{:.6f}'.format(val_mse)) for val_mse in val_mse_nodes_epochs])
    #print('Noise variable by epoch:', noise_var_epochs)
    print('Noise variable by epoch:', [float('{:.4f}'.format(noise_var)) for noise_var in noise_var_epochs])
